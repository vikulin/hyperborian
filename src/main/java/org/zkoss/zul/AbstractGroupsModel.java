...
public abstract class AbstractGroupsModel<D, H, F, E>
	...
	protected void fireEvent(int type, int groupIndex, int index0, int index1) {
		...
		List listeners = new LinkedList(_listeners);
		Consumer<? super GroupsDataListener> action = new Consumer<GroupsDataListener>() {

			@Override
			public void accept(GroupsDataListener t) {
